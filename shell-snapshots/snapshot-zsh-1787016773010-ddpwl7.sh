...
" 
	...
	case $COMMAND in
		...
		("install" | "i") local version_not_provided
			...
			if [ "${NVM_OFFLINE}" != 1 ] && ! nvm_has "curl" && ! nvm_has "wget"
			then
...
nvm_ls_cached () {
	...
	command ls -1 "${CACHE_BIN_DIR}" | nvm_grep "^node-v.*-${SUFFIX}\$" | command sed "s/^node-\\(v[0-9][0-9.]*\\)-${SUFFIX}\$/\\1/" | nvm_grep "$(nvm_ensure_version_prefix "${PATTERN}")" | command sort -t. -u -k 1.2,1n -k 2,2n -k 3,3n
}
nvm_ls_current () {
...
nvm_resolve_alias () {
	...
	do
		...
		if command printf '%b' "${SEEN_ALIASES}" | nvm_grep -q -e "^${ALIAS_TEMP}$"
		then
			ALIAS="∞" 
			break
		fi
...
if ! (unalias rg 2>/dev/null; command -v rg) >/dev/null 2>&1; then
  ...
  [[ -x $_cc_bin ]] || _cc_bin=/Users/zhizhidemac/.local/bin/claude
...
export PATH='/Users/zhizhidemac/.kimi-code/bin:/opt/homebrew/opt/mysql-client/bin:/Users/zhizhidemac/.antigravity-ide/antigravity-ide/bin:/Users/zhizhidemac/.local/bin:/Users/zhizhidemac/.local/bin:/opt/homebrew/bin:/opt/homebrew/sbin:/Users/zhizhidemac/.nvm/versions/node/v24.16.0/bin:/usr/local/bin:/System/Cryptexes/App/usr/bin:/usr/bin:/bin:/usr/sbin:/sbin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/local/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/bin:/var/run/com.apple.security.cryptexd/codex.system/bootstrap/usr/appleinternal/bin:/pkg/env/global/bin:/usr/local/corplink/mdm/opt/corplink-mdm/bin:/Users/zhizhidemac/.nvm/versions/node/v16.20.2/bin:/Users/zhizhidemac/Library/pnpm:/Users/zhizhidemac/Library/Application Support/Claude/local-agent-mode-sessions/7585cd07-f391-40ff-8b28-cd13f057ef57/2dd4a03b-3130-49fb-9037-5348944bdaf1/rpm/plugin_0155zZVATbJU3jHUmPP9NvMC/bin:/Users/zhizhidemac/Library/Application Support/Claude/local-agent-mode-sessions/skills-plugin/2dd4a03b-3130-49fb-9037-5348944bdaf1/7585cd07-f391-40ff-8b28-cd13f057ef57/bin'
