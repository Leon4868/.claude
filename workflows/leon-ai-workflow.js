// ============================================================
// leon-ai-workflow —— leon:init + leon:ai(编排内核)合并的端到端 workflow
// ------------------------------------------------------------
...
//
// 调用:Workflow({ name: 'leon-ai-workflow', args: {
...
export const meta = {
  ...
  description:
    '端到端:先 leon:init 初始化项目 .claude/,再跑 leon:ai 编排内核开发指定 feature(不做 review/标记/QA/审批,blocker 冒泡)',
  phases: [
...
if (!projectDir) {
  return { error: '缺少 args.projectDir。示例:Workflow({ name: "leon-ai-workflow", args: { projectDir: "/abs/project", feature: "2.auth" } })' };
}
